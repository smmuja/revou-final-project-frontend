          ...
          <div className="sm:flex flex-row">
            <Card key={business.id}>
              ...
              <div className="flex justify-center">
                <img src={business.profile_url} alt="" className="size-60" />
              </div>
              <img
              ...
              <div className="border-0 mr-3 p-3">
                ...
                <p className="truncate ...">
                  ...
                  Possimus aspernatur asperiores ipsa, itaque magnam recusandae,
                  voluptatum eligendi nisi molestias sequi, quas molestiae
                  inventore ea quasi perferendis commodi delectus! Qui,
                  inventore!
                </p>
              </div>
            </Card>
