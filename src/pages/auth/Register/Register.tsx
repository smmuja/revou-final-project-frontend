...
const Register = () => {
  ...
  const xIcon = <IconX onClick={handleErrorMessage} style={{ width: rem(20), height: rem(20) }} />;
  return (
    ...
    <div>
      ...
      {
        hasErrorMessage&&(
          <Notification onClick={handleErrorMessage} icon={xIcon} color="red" title="Bummer!">
            {errorMessage}
          </Notification>
        )
      }
